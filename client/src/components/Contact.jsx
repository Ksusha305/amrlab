...
const Contact = () => {
  return (
    <div className='contact'>
      <div className='foter'>
        <div className='logofootrer'>
          <div>
          <img className='logof' src="../public/ma.png" alt="Facebook Icon"></img>
          </div>
          <div>
            <div className='OOO'>
              ООО «АМР Лаб»
